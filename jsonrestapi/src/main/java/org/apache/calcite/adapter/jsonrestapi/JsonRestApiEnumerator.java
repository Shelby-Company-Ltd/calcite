...
public class JsonRestApiEnumerator implements Enumerator<@Nullable Object[]> {

  private final Enumerator<@Nullable Object[]> enumerator;

  public JsonRestApiEnumerator(List<? extends @Nullable Object> list) {
   ...
   * of a JSON file. */
  static JsonRestApiEnumerator.JsonDataConverter deduceRowType(RelDataTypeFactory typeFactory, Source source) {
    ...
    return new JsonRestApiEnumerator.JsonDataConverter(relDataType, list);
  }
